...
BITRIX_PORTAL_TOKEN_MAX_AGE_SECONDS = get_int_env(
...
ROBOKASSA_TEST_PASSWORD1 = get_env("ROBOKASSA_TEST_PASSWORD1", default="")
ROBOKASSA_TEST_PASSWORD2 = get_env("ROBOKASSA_TEST_PASSWORD2", default="")
...
CELERY_TASK_ROUTES = {
    "apps.reports.tasks.run_report_build_task": {"queue": "reports"},
    "apps.dashboard.tasks.run_dashboard_refresh": {"queue": "reports"},
}

      ...
      >
        <div className="modal-head">
          <div>
            ...
            <span>Месячная подписка: сохранённые настройки, доступы и быстрые повторные отчёты.</span>
          </div>
          <button className="icon-button" type="button" aria-label="Закрыть окно" onClick={onClose}>
            <X size={18} />
          </button>
                ...
                <section className="pro-plan-card pro-plan-card-paid">
                  <div className="pro-plan-content">
                    ...
                    <p className="pro-plan-description">
                      ...
                      Данные построенных отчётов тоже сохраняются на сервере, чтобы следующие расчёты
                      шли быстрее.
                    </p>
                  </div>
                  <div className="pro-plan-footer">
      ...
      <div className="modal-panel instruction-modal-panel" role="dialog" aria-modal="true" aria-label="Как читать отчёт">
        ...
        <div className="instruction-content">
          ...
          <section className="instruction-section" id="instruction-about">
            ...
            <p>
              Отчёт можно скачать через кнопку <b>Скачать</b>: Excel (только таблица),
              PDF без графиков (цифры и главный график) или PDF с графиками
              (то же плюс графики по всем показателям и сотрудникам в таблице).
            </p>
            <div className="instruction-demo demo-toolbar">
              ...
              <span className="demo-button demo-green">Скачать ▾</span>
            </div>
          </section>
          ...
          <section className="instruction-section" id="instruction-build">
            ...
            <ol>
              ...
              <li>
                Нажмите <b>Построить отчёт</b> — по выбранным вручную настройкам —
                или <b>Построить автоматически</b>, чтобы система сама подобрала показатели.
              </li>
            </ol>
            <p>
              Переключатель коридоров независим: его можно использовать и с ручным построением,
              и с автоматическим.
            </p>
            <p>
              В ПРО версии данные построенного отчёта сохраняются на сервере. Первый расчёт
              запрашивает Битрикс24, а повторные отчёты за тот же или уже сохранённый период
              считаются быстрее.
            </p>
            <p>
              При автопостроении система сама выбирает доступный главный показатель
          ...
          <section className="instruction-section" id="instruction-chart">
            ...
            <p>
              ...
              подсказку с датой и суммой. Светлая прямая <b>Тренд</b> — это линейная регрессия (МНК) по значениям
              за выбранный период: она показывает общее направление изменения, а не прогноз.
            </p>
          ...
          <section className="instruction-section" id="instruction-thresholds">
            ...
            <p>
              ...
              <b> Применить</b>. Ручные значения сохраняются, пока вы явно не выберете
              автоматический режим; при замене система попросит подтверждение.
              Закрыть окно коридора можно крестиком — тогда вы вернётесь к настройкам
              главного показателя. Также укажите <b>Как оценивать показатель?</b> — это влияет только на цвет подсветки
          ...
          <section className="instruction-section" id="instruction-settings">
            ...
            <p>
              Галочка <b>Скрыть нулевые показатели</b> убирает из таблицы (и из скачивания) строки, где за весь
              период только нули или «—». Если в каких-то датах есть ненулевые значения — строка останется.
            </p>
            <p>
          ...
          <section className="instruction-section" id="instruction-pro">
            <h2>ПРО версия</h2>
            <p>
              ПРО версия позволяет сохранять много вариантов отображения отчёта.
              Также в ПРО данные построенных отчётов сохраняются на сервере, чтобы следующие отчёты
              считались быстрее и не ждали повторный ответ Битрикс24.
            </p>
            <p>
              Последние 6 месяцев подготавливаются в фоне. Если построить отчёт за более длинный
              период — например за год — эти данные тоже сохраняются. Повторно такой период считается
              уже из сохранённой копии.
            </p>
          </section>
          ...
          <section className="instruction-section" id="instruction-faq">
            ...
            <p>
              Нажмите <b>Скачать</b> и выберите вариант: Excel, PDF без графиков или PDF с графиками
              (графики строк выгружаются по всей таблице, даже если на экране они свёрнуты).
            </p>
            <h3>Почему первый отчёт в ПРО может считаться долго, а следующий быстрее?</h3>
            <p>
              Первый расчёт берёт данные из Битрикс24. В ПРО они сохраняются на сервере, поэтому повторные
              отчёты за тот же или уже сохранённый период считаются быстрее.
            </p>
          </section>
        </div>
      </div>

        ...
        <div className="instruction-content">
          ...
          <section className="instruction-section" id="instruction-thresholds">
            ...
            <p>
              ...
              Коридор можно настроить вручную или применить расчет системы.
            </p>
            <p>
              Расчет системы формируется по данным текущего графика или строки таблицы
              за период отчёта (период указан в подсказке в окне коридора).
